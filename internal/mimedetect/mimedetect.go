...
var (
	...
	ErrNilMagicSignature = errors.New("mimedetect: magic signature cannot be nil")
)
...
var builtInSignatures = []MagicSignature{
	...
	{[]byte{0x52, 0x49, 0x46, 0x46}, 0, OffsetFixed, "image/webp"},
	...
	{[]byte{0x52, 0x49, 0x46, 0x46}, 0, OffsetFixed, "audio/wav"},
	...
	{[]byte{0x52, 0x49, 0x46, 0x46}, 0, OffsetFixed, "audio/x-wav"},
